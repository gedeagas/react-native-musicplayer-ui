...
export default class DetailPScreen extends Component {
      ...
      <View style={styles.container}>
        ...
        >  
            ...
            <Image
                ...
                source={require('../assets/paramorebg.jpg')}
            />
            ...
            style={styles.linearGradient}>
              ...
              <View style={styles.detailTitleContainer}>
                <View>
                  <Text style={styles.detailTitle}>After Laughter</Text>
                  <Text style={styles.detailSubTitle}>Paramore</Text>
                </View>
